...
const slideLocal3 = [
  {
    ...
    rate: 5,
    price: "1000$",
    feature: ["Số tự động", "Giao xe tận nơi"],
                ...
                <div className="tab-right">
                  <TabPanel>
                    <Form>
                      ...
                      <Button
                        variant="primary"
                        className="btn form-control mt-3 text-primary"
                      >
                        <BsSearch /> Tìm Kiếm Ngay
                      </Button>
                    </Form>
                  </TabPanel>
                  <TabPanel>
                  ...
                  <div className="content-detail">
                    <Link style={{ textDecoration: "none" }} to="/howitword">
                      ...
                      <Rating
                        ...
                        emptySymbol={
                          <img src={starempty} className="icon" alt="" />
                        }
                        fullSymbol={
                          <img src={starfull} className="icon" alt="" />
                        }
                        readonly
                      />
                      <p>
                        <IoPricetagsSharp /> {slider.price}
                        <span className="num-rental">
                          <RiNumbersFill /> {slider.quality}
                        </span>
                      </p>
                      <p>
                        <IoLocation /> {slider.address}
                      </p>
                      <p>
                        <AiFillSetting /> {slider.feature[0]}-
                        {slider.feature[1]}
                      </p>
                    </Link>
                  </div>
