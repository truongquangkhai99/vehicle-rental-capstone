...
import { GiCarSeat, GiGears, GiPassport, GiFuelTank } from 'react-icons/gi'
                ...
                <Row className="vehicle__body container">
                    <Col lg={7} className="vehicle__body-content">
                        <div className="heading">
                            <h1 className="title-vehicle">TOYOTA VIOS E 2015</h1>
                            ...
                            <Row className="desc-item">
                                ...
                                <Col lg={9} className="desc-content">
                                    <Row>
                                        ...
                                        <Col lg={6}>
                                            <span><i id="icon-vehicle" style={{ top: "-21%" }}><GiFuelTank /></i>Nhiên liệu: Xăng</span>
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
